...
parser.add_argument('--use_inverse_relation', default=False,action='store_true')
...
# RL options
parser.add_argument('--filter_sub', default=False,action='store_true')
parser.add_argument('--encode_type', default=False,action='store_true')
parser.add_argument('--reason_kb', default=False,action='store_true')
...
parser.add_argument('--tree_soft', default=False,action='store_true')
parser.add_argument('--filter_label', default=False,action='store_true')
parser.add_argument('--share_embedding', default=False,action='store_true')
parser.add_argument('--share_instruction', default=False,action='store_true')
